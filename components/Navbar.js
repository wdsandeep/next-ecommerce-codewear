...
const Navbar = ({
  ...
  return (
    <>
      <span>
        {dropdown && (
          <div
            ...
            className="absolute right-8  bg-white shadow-lg border top-8 rounded-md px-5 w-36 z-30 "
          >
            <ul>
              <Link href={"/myaccount"}>
                <a>
      ...
      <div
        className={`flex flex-col md:flex-row md:justify-start justify-center items-center my-1 shadow-md sticky top-0 bg-white z-10 ${
      ...
      >
        ...
        <div className="cart absolute right-0 mx-5 top-2 md:top-3 cursor-pointer flex items-center">
          ...
          >
            {user.value && (
              <MdAccountCircle className="text-xl md:text-2xl mx-2 mr-5 " />
            )}
          </span>
          <AiOutlineShoppingCart
            onClick={toggleCart}
        ...
        <div
          ref={ref}
          className={`sidecart overflow-y-auto w-72 h-[100vh] absolute top-0  bg-pink-100 py-10 px-8  transition-all ${
